...
Nous nous intéresserons au support convexe de la loi de $T(X)$ plutât qu'à celui de la loi de $X$
...
$$\theta \mapsto \langle \theta, t\rangle - \log Z(\theta)$$  atteint son supremum dans $\Theta$  si et seulement s'il existe $\widehat{\theta} \in \Theta$  tel que
$t = \nabla \log Z(\widehat{\theta})$ 
...
### Définition : _information de Fisher_
...
On défonit la région aléatoire $\widehat{A}_n(\alpha)$ par

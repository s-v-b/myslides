...
![Jane Azar](https://avatars1.githubusercontent.com/u/895125?s=400&v=4){width=80%}


Contact {#contact}
--------------------------------------------------------------------------------

- <i class="fa fa-envelope"></i> jane.azar2000@gmail.com
...
- C, `r fontawesome::fa("java")`, , `r fontawesome::fa("python")`, 


Disclaimer {#disclaimer}
--------------------------------------------------------------------------------

Ce Curriculum Vitae est composé avec le package `r fontawesome::fa("r-project")` [**pagedown**](https://github.com/rstudio/pagedown).
...
### Lycée Mar Doumit-Sœurs Antonines Roumieh Metn-Liban

Baccalauréat Scientifique Libanais 

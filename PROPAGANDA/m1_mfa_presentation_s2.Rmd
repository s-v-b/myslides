...
params:
  ...
  campus: "Grands Moulins Halle aux Farines Amphi 4C"
output:
  xaringan::moon_reader:
    css: ["header-footer.css", "xaringan-themer.css", timetable.css]
    lib_dir: libs
    seal: false
    nature:
      nature:
...
[Lien Zoom](https://u-paris.zoom.us/j/86095880979?pwd=J9fHGoEjcrB5GHRAJCkHBUQPOqAoc4.1)
...
Horaire : `r hms::as_hms(debut + 5 * quart_d_heure)`
...
[Synopsis](http://s-v-b.github.io/MA7BY020)
]

.fr.w-50.pa2.f6[

```{r, echo=F}
knitr::include_url("http://s-v-b.github.io/MA7BY020", height="400px")
```

...
- LOGOS .fr[`r fontawesome::fa("university")`]

Ces parcours ont trois grands types de débouchés `r fontawesome::fa("industry")` `r fontawesome::fa("chalkboard-teacher")` `r fontawesome::fa("university")`

.center[**M1 Pro**]

- ISIFAR   .fr[`r fontawesome::fa("hand-holding-usd")`]
- MIDS   .fr[`r fontawesome::fa("hand-holding-usd")`]
- MIC    .fr[`r fontawesome::fa("hand-holding-usd")`]
...
| [LOGOS](https://master.math.univ-paris-diderot.fr/annee/m2-logos/)|  | `r fontawesome::fa("university")`| 

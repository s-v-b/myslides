---
title: "Master I Parcours Mathématiques Fondamentales et Appliquées (MFA)"
subtitle: "Mention Mathématiques et Applications"
...
# [Master Mention Mathématiques et Applications](http://master.math.univ-paris-diderot.fr)

## [Master I  Parcours Mathématiques Fondamentales et Appliquées](http://master.math.univ-paris-diderot.fr/annee/m1-math/)
...
### Master Mathématiques et Applications (GM et SGdP) 


```{r, echo=FALSE}
knitr::include_graphics("./img/formation_master_2025_bis.svg")
```
...
<tr>
  <td>
  <a href="http://master.math.univ-paris-diderot.fr/modules/m1math-s1-algebre/" class="plain">Théorie des Corps, Théorie de Galois</a>
  </td>
  <td>9</td>
</tr>
...
<tr>
  ...
  <a href="http://master.math.univ-paris-diderot.fr/modules/m1math-s1-analyse/" class="plain">Analyse et Topologie</a>
  </td>
  <td>9</td>
</tr>
...
| Intitulé   du cours                                     |       ECTS | Horaire    |
|:--------------------------------------------------------|:----------:|:----------:|
| [Anneaux et Modules]()                                      |     9      | .f6[3hCM + 4hTD]|
| [Analyse et EDP]()                                          |     9      | .f6[3hCM + 4hTD]|
| [Géométrie différentielle]()                                |     9      | .f6[3hCM + 4hTD]|
| [Processus et Théorèmes Limites]()                          |     9      | .f6[3hCM + 4hTD]|
| [Statistique]()                                             |     9      | .f6[3hCM + 4hTD]|
| Arithmétique                                            |     6      | .f6[2hCM + 2h30TD]|
| Théorie des ensembles                                   |     6      | .f6[2hCM + 2h30TD]|
| Incomplétude et indécidabilité                          |     6      | .f6[2hCM + 2h30TD]|
| Topologie algébrique                                    |     6      | .f6[2hCM + 2h30TD]| 
| Optimisation                                            |     6      | .f6[2hCM + 2h30TD]| 
| Mathématiques financières                               |     6      | .f6[2hCM + 2h30TD]|
| Méthodes numériques pour les EDO et les EDP             |     6      | .f6[2hCM + 2h30TD]|
| Ouverture                                              |     6      | .f6[2hCM + 2h30TD]|
| Analyse exploratoire de données                         |     3      | .f6[3hCTD]        |
| Projet ou Initiation à la Recherche                     |     3      |                   |
| Sport ou Engagement étudiant                            |     3      |                   |
...
Il faut valider 30 ECTS  parmi les cours listés à droite
...
|:--------------------------------------------------------|:----------:|
| Processus Stochastiques et Théorèmes Limites            |     9      |
| Statistique                                             |     9      | 
| Optimisation                                            |     6      | 
| Mathématiques financières                               |     6      | 
| Méthodes numériques pour les EDO et les EDP             |     6      | 
| Analyse exploratoire de données                         |     3      | 
| Projet                                                  |     3      |



.f6[Plusieurs choix possibles et raisonnables] `r fontawesome::fa("smile")`
...
Il faut valider 30 BECTS  parmi les cours listés à droite
...
.f6[
  Plusieurs choix possibles et raisonnables] `r fontawesome::fa("smile")`

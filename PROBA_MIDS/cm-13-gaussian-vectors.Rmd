---
title: "Probability XIII: Gaussian Vectors"
...
`r fontawesome::fa("hand-point-right")` this is does not depend on any Gaussianity assumption
...
A positive definite  matrix $K$ admits a _Cholesky decomposition_, in other words, there exists a triangular matrix lower than $L$ such that
$$K = L \times L^T$$
...
the sequence  $(X_n)_n$  converges in distribution towards $\mathcal{N}\left(\vec{\mu}, K\right)$ (if $K = 0$,
...
- $\operatorname{var}(Y)=\sigma^2_y$ and

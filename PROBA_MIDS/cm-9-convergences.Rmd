...
.bg-light-gray.b--lighy-gray.ba.bw1.br3.shadow-5.ph4.mt5[
...
$$\limsup_n P\Bigg\{ \Big|\frac{1}{n}\sum_{i=1}^n X_i - \mu\Big| > \epsilon\Bigg\} \leq 2  \frac{\mathbb{E}\Big|Y^\tau_1 \Big|}{\epsilon}$$
...
that 
$$\lim_{\tau \uparrow \infty}  \frac{\mathbb{E}\Big|Y^\tau_1 \Big|}{\epsilon}=0$$

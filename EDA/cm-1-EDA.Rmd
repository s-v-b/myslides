...
# I :  Introduction to `r fontawesome::fa("r-project")`
...
- 1991-93 `r fontawesome::fa("r-project")` initated by [R. Ihaka](https://en.wikipedia.org/wiki/Ross_Ihaka) and [R. Gentleman](https://en.wikipedia.org/wiki/Robert_Gentleman_(statistician))
...
- Functional (inherited from [Scheme](https://en.wikipedia.org/wiki/Scheme_(programming_language)))
...
- Interfaced with `r fontawesome::fa("database")` SQL
...
- `Rstudio` `r fontawesome::fa("glass-cheers")`
...
- cleaner data structures (`tibble`, `data.table`, ...)

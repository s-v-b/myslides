...
- describe dataframes from an end-user viewpoint (we leave aside implemenations)
...
- [`nycflights13`](https://github.com/tidyverse/nycflights13) provides the dataframes we paly with

...
as many rows as there are individuals in the sample 

If we project on either coordinate, we obtain a univariate sample (`df$X`, `df[["X"]]` or `df$Y`).
...
.panel[.panel-name[Preparing for loading]

...
This effect may depend on the feeding regime condition (treatment)
...
tidy(lm_fit) %>%
  ...
  geom_segment(aes(xend=term, y=estimate-2*std.error, yend=estimate+2*std.error)) +
  coord_flip() +
  ggtitle("Home made dotandwhiskerplot")

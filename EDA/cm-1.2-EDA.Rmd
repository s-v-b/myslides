...
We supply _aesthetic mappings_ (`aes()`) that can be either global
or bound to some _geometries_ (`geom_point()`)or _statistics_ 
...
```{r  gap_gganimate, warning=FALSE, message=FALSE, eval=FALSE}

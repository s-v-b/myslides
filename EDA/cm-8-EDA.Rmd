...
Clustering consists in partitioning  points collections
...
a metric/dissimilarity over some input space. 
...
But the three reasonable goals are _conflicting_
...
We can compare classification originating from _phenotypes_ (appearance) and classification based on _phylogeny_ (comparing DNAs)

...
#### [Stéphane Bocuheron](http://stephane-v-boucheron.fr)
...
$$\overline{X}_n = \frac{1}{n}\sum_{i=1}^n x_i \qquad  \text{(location)}$$

- Standard deviation:

$$s^2 = \frac{1}{n-1} \sum_{i=1}^n \big(x_i - \overline{X}_n\big)^2 \quad \text{or}\quad s^2 = \frac{1}{n} \sum_{i=1}^n \big(x_i - \overline{X}_n\big)^2\qquad\text{(dispersion)}$$
...
- Hill Randomized Clinical Trial Streptomyces versus Collapsotherapia against Tuberculosis 1948

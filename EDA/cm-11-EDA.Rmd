...
### `r fontawesome::fa("ship")` Double-decker plot for the Titanic data
...
- Normalize $P = \frac{1}{N}X$
- Let $D_r$ denote the diagonal matrix with row sums of $P$ as coefficients
- Let $D_c$ denote the diagonal matrix with column sums of $P$ as coefficients

The matrix of interest is the row profiles matrix
$$D_r^{-1} \times P$$

CA consists in either

- computing the extended SVD of
$$D_r^{-1} \times P \times D_c^{-1}- \mathbf{I}\times \mathbf{I}^T $$
with respect to $D_r$ and $D_c$
- computing the SVD of the Pearson's residuals matrix and perform some post-processing

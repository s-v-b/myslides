...
defined by the four columns `Sex`, `Age`, `Embarked`, `Pclass`. `Survived` plays no role in the definition 
of the factorial subspaces
...
CA consists in computing the extended SVD of 
...
The row sums of an incidence matrix are equal to the number of variables of the data matrix

The column sums of an incidence matrix are equal to the numbers of occurrences of the corresponding levels
